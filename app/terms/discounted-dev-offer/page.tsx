      ...
      <main className="max-w-4xl mx-auto w-full py-16">
        ...
        <div className="mt-16 text-center pb-6 sm:pb-0">
          <Link href="/services/SpecialOfferPage">
            <button className=" cursor-pointer bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full shadow-md hover:scale-105 transition-transform">
              ⬅ Back to Offer Page
            </button>
          </Link>
        </div>
