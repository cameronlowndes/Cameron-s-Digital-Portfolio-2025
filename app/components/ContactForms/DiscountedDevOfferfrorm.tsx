...
export default function DiscountedDevOfferForm() {
  const [state, handleSubmit] = useForm("mqablyld");

  const serviceTiers = ["Starter", "Professional", "Premium", "Ultimate"];

  const addOns = [
    { id: "ecommerce", name: "E-commerce integration (Stripe)", price: "+£300" },
    { id: "multilingual", name: "Multilingual support", price: "+£200" },
    { id: "updates", name: "Monthly updates & monitoring", price: "+£160/month" },
    { id: "hosting", name: "Hosting migration & setup", price: "+£75" },
    { id: "removeAttribution", name: "Remove attribution", price: "+£150" },
  ];
