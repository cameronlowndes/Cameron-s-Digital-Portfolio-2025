    ...
    >
      ...
      <div>
        ...
        >
          ...
          <option value="Professional £350">🔵 Professional  £350</option>
          <option value="Premium  £550+">🟣 Premium  £550+</option>
        </select>
      </div>
      ...
      <div>
        ...
        <div className="space-y-2 pl-2">
          <label className="flex items-center gap-2">
            <input type="checkbox" name="addOns" value=" E-commerce-ready templates: £200+" />
          ...
          <label className="flex items-center gap-2">
            <input type="checkbox" name="addOns" value="Monthly updates + hosting support: +£120/mo" />
