    ...
    <div className="min-h-screen flex flex-col pt-16 bg-gradient-to-b from-indigo-900 via-purple-900 to-pink-900 px-6 text-white">
      <main className="max-w-7xl mx-auto w-full py-20">
        ...
        >
          ...
          <motion.div className="grid md:grid-cols-4 sm:grid-cols-1 gap-10 items-stretch">
            <PackageCard
              color="green"
              title="Starter"
              price="£299"
        ...
        >
          ...
          >
            {[
              "E-commerce integration (Stripe): +£300",
              "Multilingual support: +£200",
              "Monthly updates & monitoring: +£160/month",
              "Hosting migration & setup: +£75",
              "Remove attribution: +£150",
            ].map((item, i) => (
...
function PackageCard({
  ...
  return (
    <motion.div
      className={`bg-gradient-to-tr ${bgMap[color]} rounded-3xl shadow-2xl p-8 border-t-8 flex flex-col transform cursor-pointer select-none`}
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
      variants={fadeInUpVariants}
